...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --board R2A73030BR00 --dt device/alcatel/pop35/dt.img
TARGET_PREBUILT_KERNEL := device/alcatel/pop35/kernel
...
TARGET_RECOVERY_FSTAB := device/alcatel/pop35/twrp.fstab
